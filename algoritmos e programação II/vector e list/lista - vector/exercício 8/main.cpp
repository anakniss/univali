...
void read_vector(string, vector<int> &);
...
int main()
{
    ...
    read_vector("Informe um valor a ser adicionado no vetor A: ", a);
    read_vector("Informe um valor a ser adicionado no vetor B: ", b);
...
void read_vector(string message, vector<int> &vector){
    char option;
    int n;
    do {
        cout << message << endl;
